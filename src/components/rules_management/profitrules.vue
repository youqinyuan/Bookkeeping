        ...
        <div>
            <ul>
                <li v-for="(ite,index) in content" :key="index">
                    ...
                    <div class="details">
                        <div>
                            Plus会员：占利润空间的{{ite.items[0].plusRate}}%
                        </div>
                        <div>
                            代理商：占利润空间的{{ite.items[0].agentRate}}%
                        </div>
                        <div>
                            平台：占利润空间的{{ite.items[0].platformRate}}%
                        </div>
                        <div>
                            Plus会员：占商品付款金额的{{ite.items[0].plusPaymentRate}}%
                        </div>
                    </div>
                    <div class="mr" v-if="ite.isDefault === 1"> 
                        默认使用
                    </div>
...
<script>
import {getProfitsDistributions,modifyProfitsDistribution} from '@/network/api'
