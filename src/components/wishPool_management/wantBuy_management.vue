  ...
  <div class="setProductContent">
    ...
    <div class="tableContent">
      <el-table :data="tableData" style="width: 100%;margin-top:40px;" border>
        ...
        <el-table-column label="加入购物车人数" prop="cartCount" align="center"></el-table-column>
        <el-table-column label="提交订单并支付成功人数" prop="paidCount" align="center"></el-table-column>
