  ...
  <div class="return">
    ...
    <div class="tableBox">
      <el-table :data="tableData" border style="width: 100%">
        ...
        <el-table-column prop="vendorMobile" label="卖方电话" align="center"></el-table-column>
        <el-table-column prop="purchaserMobile" label="买方电话" align="center"></el-table-column>
        <el-table-column prop="platformOrgAmount" label="商品原价" align="center"></el-table-column>
        <el-table-column prop="periodLeft" label="待返期数" align="center"></el-table-column>
        <el-table-column prop="vendorPaymentAmount" label="卖方支付金额" align="center"></el-table-column>
        <el-table-column prop="expectAmount" label="成交价" align="center"></el-table-column>
...
<script>
import { findGoodsPreSaleEconomyTopicPageList } from "@/network/api";
export default {
  data() {
    return {
      pageSize: 10,
  ...
  methods: {
    ...
    search(val) {
      ...
      findGoodsPreSaleEconomyTopicPageList({ params: parms }).then(res => {
