  ...
  <div class="return">
    ...
    <div class="tableBox">
      <el-table :data="tableData" border style="width: 100%">
        ...
        <el-table-column prop="cashBackAmount" label="待返金额" align="center"></el-table-column>
        <el-table-column prop="expectAmount" label="售价" align="center"></el-table-column>
        <el-table-column prop="annualizedRate" label="年化收益" align="center">
          <template slot-scope="scope">
            <span>{{scope.row.annualizedRate}}%</span>
          </template>
        </el-table-column>
...
<script>
import { findAdvanceOrderTopicPageList } from "@/network/api";
export default {
  data() {
    return {
      pageSize: 10,
  ...
  methods: {
    ...
    search(val) {
      ...
      findAdvanceOrderTopicPageList({ params: parms }).then(res => {
