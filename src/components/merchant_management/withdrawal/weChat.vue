<template>
  <div class="weChat">
    <div class="searchBox" style="margin-top:20px;">
      <div>
        <span>电话：</span>
        <el-input v-model="form.mobileNumber" style="width:140px;"></el-input>
    ...
    >
      ...
      <div style="margin-top:10px;font-size:12px;">*黑名单中的商户微信提现将无法自动通过，需要手动审核通过</div>
...
export default {
  ...
  methods: {
    ...
    setAutoPass(status) {
      ...
      merchantSetAutoAdopt(this.qs.stringify(obj)).then(res => {
        if (res.data.messageCode == "MSG_1001") {
          this.merchantAutoAdoptSet();
