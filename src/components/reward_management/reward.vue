  ...
  <div class="contents">
    ...
    <div style="margin-top:30px">
      <el-table :data="tableData" border style="width: 100%">
        ...
        <el-table-column prop="incomeName" align="center" label="用户名"></el-table-column>
        ...
        <el-table-column prop="gainAmount" align="center" label="获得奖金"></el-table-column>
        <el-table-column prop="gainReason" align="center" label="获得原因"></el-table-column>
      </el-table>
      <div class="bot">
