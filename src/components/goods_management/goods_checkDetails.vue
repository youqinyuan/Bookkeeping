  ...
  <div class="contents">
    <div class="details_content">
      ...
      <div class="details">
        ...
        <div class="goodsimg mar_bot">
          商品图片：
          <el-image
            v-for="(item,index) in details.imageUrls"
            :key="index"
    ...
    <div class="details_content" v-show="RenderGoodsSpec.length > 0">
      ...
      <div class="details">
        ...
        <el-row type="flex" class="table_content">
          ...
          <el-col v-for="(item, index) in 5" :key="'item' + index">
            <el-row
    ...
    <div class="details_content">
      ...
      <div class="details">
        <div class="mar_bot">
          <span
            v-for="(item,index) in details.competitorPrices"
            :key="index"
          >{{item.mallName}}：{{item.price}}元</span>
        </div>
      </div>
    </div>
    ...
    <div class="details_content">
      ...
      <div class="details">
        <div class="mar_bot" v-for="(item,index) in details.introductions" :key="index">
          ...
          <el-image v-else :src="item.content" fit="contain"></el-image>
        </div>
      </div>
    </div>
    ...
    handleStockDetail(detail) {
      ...
      for (let i = 0; i < keyArr.length; i++) {
        ...
        this.userInputSpecDetail[3][i] =
          detail[item].specCashBacks.length === 0
            ? ""
            : detail[item].specCashBacks[0].amount;
