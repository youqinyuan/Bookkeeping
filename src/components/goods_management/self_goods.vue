<template>
    <div class="slef_content">
        ...
        <div class="inline_box">
            <span>库存低于:</span>
            <el-input class="inp" v-model="LowerCount" placeholder="例：10"></el-input>
        </div>
...
<script>
import {platGoodsList,getAllGoodsCategory,updateGoodsIssueStatus,addPlatTag} from '@/network/api'
export default {
    props: {
    ...
    methods: {
        ...
        getplatGoodsList(data){
            let param = {pageNumber:this.pageNumber, pageSize:10, ...data}
            // console.log(param)
