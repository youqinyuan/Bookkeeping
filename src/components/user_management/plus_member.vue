    ...
    <div class="contents">
        ...
        style="width: 100%">
            ...
            <el-table-column
                ...
                align="center">
                <template slot-scope="scope">
                    <span style="color:red;cursor: pointer;" @click="reduceAssets(scope.row)">{{scope.row.balance}}</span>
                </template>
            </el-table-column> 
            <el-table-column
                prop="consumeBalance"
            ...
            <el-table-column label="操作" width="290" align="center">
                <template slot-scope="scope">
                    ...
                    size="mini"
                    type="danger"
                    @click="changeStatus(scope.$index, scope.row)">冻结</el-button>
                    <el-button
                    v-else
                    size="mini"
                    type="success"
                    @click="changeStatus(scope.$index, scope.row)">解冻</el-button>
                    <el-button
                    size="mini"
                    type="primary"
                    @click="goDetail(scope.$index, scope.row)">查看详情</el-button>
                    <el-button
                    size="mini"
                    type="primary"
                    @click="changePT(scope.$index, scope.row)">转为普通会员</el-button>
                </template>
            </el-table-column>                       
        </el-table>
...
<script>
import {plusMemberList,exchangeMemberStatus,exchangeMemberRole} from '@/network/api'
...
export default {
    ...
    methods: {
        ...
        // 转为plus会员
        changePT(index,row){
            this.$confirm('确认要将该plus会员转为普通会员吗？', '转为普通会员', {
            confirmButtonText: '确定',
            cancelButtonText: '取消',
            type: 'warning'
            }).then(() => {
