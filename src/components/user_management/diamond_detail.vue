<template>
  <div class="diamond_detail">
    ...
    <div class="content" style="border-top:1px solid #ccc;border-bottom:1px solid #ccc;">
      ...
      <div>
        <span>提现使用姓名：</span>
        <span v-for="(item,index) in content.withdrawNameList" :key="index">{{item}}</span>
      </div>
      ...
      <div class="items">注册时间：{{content.registryTime | dateFormat}}</div>
      ...
      <div>
        <div class="items" v-for="(item,index) in content.addressBooks" :key="index">
    ...
    <!-- 钻石合伙人身份收益 -->
    <div class="title" style="margin-top:10px;border-bottom:1px solid #ccc;">
    ...
    <div style="margin-top:10px;">
      第N级数量：钻石合伙人数量：{{content.diamondTeamCountN}}，合伙人：{{content.plusTeamCountN}}个，普通用户：{{content.normalTeamCountN}}个
    </div>
    <div style="margin-top:10px;">
    ...
    <div style="display:flex;margin-top:30px;">
      ...
      <el-pagination @current-change="handleCurrentChange1" :page-size="10" layout="prev, pager, next"
        :total="openDiamondMemberIncomeItemsTotal"></el-pagination>
    </div>
    ...
    <div style="display:flex;margin-top:30px;">
      ...
      <el-pagination @current-change="handleCurrentChange2" :page-size="10" layout="prev, pager, next"
        :total="teamBuyGoodsIncomeItemsTotal"></el-pagination>
    </div>
    ...
    <div style="display:flex">
      ...
      <div>
        <div style="display:flex;margin-top:10px;">
          <span class="demonstration">线上消费：{{content.onlineConsumeSum}}元（总计：{{onlineConsumeItemsTotal}}条）</span>
          <el-pagination @current-change="handleCurrentChange3" :page-size="10" layout="prev, pager, next"
            :total="onlineConsumeItemsTotal"></el-pagination>
        </div>
        <div style="width:700px;margin-top:10px;">
      ...
      <div style="margin-left:20px;">
        <div style="display:flex;margin-top:10px;">
          <span class="demonstration">线下消费：{{content.offlineConsumeSum}}元（总计：{{offlineConsumeItemsTotal}}条）</span>
          <el-pagination @current-change="handleCurrentChange4" :page-size="10" layout="prev, pager, next"
            :total="offlineConsumeItemsTotal"></el-pagination>
        </div>
        <div style="width:700px;margin-top:10px;">
    ...
    <!-- 冻结历史： -->
    <div class="title" style="margin-top:20px;padding-bottom:10px;border-bottom:1px solid #ccc;">冻结历史：</div>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      diamondMemberDetail() {
        ...
        diamondMemberDetail({
          ...
          if (res.data.messageCode == "MSG_1001") {
            ...
            // 种子明细
            this.seedItemsData = data.seedRecordItems.items;
            this.seedItemsSize = data.seedRecordItems.totalSize;
            // 邀请好友记录
      ...
      // 种子明细翻页
      pageSeedItems(val) {
        this.diamondMemberDetailItmes(val, 14);
      },
