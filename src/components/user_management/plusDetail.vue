    ...
    <div class="common">
      ...
      <div class="content">
        ...
        <ul>
          ...
          <li>
            注册来源：{{ content.registrySource | registrySource }}(注册的渠道)
          </li>
    ...
    <div class="common">
      ...
      <div class="content">
        ...
        <div class="table_content">
          <div class="table_top">
            <span>线上收益记录表（正利润）：(总计:{{
                onlineProfitIncomeItemsSize
              }}条)</span>
            <el-pagination background layout="prev, pager, next" :total="onlineProfitIncomeItemsSize" :page-size="10"
              @current-change="pageChangeOnlineSY($event)"></el-pagination>
          </div>
          ...
          <div class="table_top">
            <span>线上收益记录表（无利润/负利润）：(总计:{{
                onlineLossIncomeItemsSize
              }}条)</span>
            <el-pagination background layout="prev, pager, next" :total="onlineLossIncomeItemsSize" :page-size="10"
              @current-change="pageChangeOnlineFSY($event)"></el-pagination>
          </div>
          ...
          <div class="table_top">
            ...
            <el-pagination background layout="prev, pager, next" :total="offlineIncomeItemsSize" :page-size="10"
              @current-change="pageChangeOfflineSY($event)"></el-pagination>
          </div>
        ...
        <div class="xiaofei_table">
          <div class="top">
            <span>线上消费：{{ content.onlineConsumeSum }}元 (总计：{{
                onlineConsumeItemsSize
              }}条)</span>
            <el-pagination background layout="prev, pager, next" :total="onlineConsumeItemsSize" :page-size="10"
              @current-change="pageChangeOnlineXF($event)"></el-pagination>
          </div>
        ...
        <div class="xiaofei_table">
          <div class="top">
            <span>线下消费：{{ content.offlineConsumeSum }}元 (总计：{{
                offlineConsumeItemsSize
              }}条)</span>
            <el-pagination background layout="prev, pager, next" :total="offlineConsumeItemsSize" :page-size="10"
              @current-change="pageChangeOfflineXF($event)"></el-pagination>
          </div>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      // 种子明细翻页
      pageSeedItems(val) {
        this.getplusMemberDetailItems(val, 14);
      },
