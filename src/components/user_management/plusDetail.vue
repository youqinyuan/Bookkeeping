    ...
    <div class="common">
      ...
      <div class="content">
        ...
        <div class="table_content">
          ...
          <el-table :data="onlinetableDataSY" border style="width: 100%">
          ...
          <el-table :data="onlinetableDataFSY" border style="width: 100%">
            <el-table-column prop="createTime" label="到账时间" align="center">
              <template slot-scope="scope">{{scope.row.createTime | dateFormat}}</template>
            </el-table-column>
            <el-table-column prop="storeName" label="商户" align="center" show-overflow-tooltip></el-table-column>
          ...
          <el-table :data="offlinetableDataSY" border style="width: 100%">
            <el-table-column prop="createTime" label="到账时间" align="center">
              <template slot-scope="scope">{{scope.row.createTime | dateFormat}}</template>
            </el-table-column>
            <el-table-column prop="storeName" label="商户" align="center" show-overflow-tooltip></el-table-column>
    ...
    <div class="common">
      ...
      <div class="content">
        <div class="xiaofei_table">
          ...
          <el-table :data="onlinetableDataXF" border style="width: 100%">
        ...
        <div class="xiaofei_table">
          ...
          <el-table :data="offlinetableDataXF" border style="width: 100%">
      ...
      plusMemberDetail({ params: parms }).then(res => {
        if (res.data.messageCode == "MSG_1001") {
          this.onlinetableDataSY =
            res.data.content.onlineProfitIncomeItems.items;
          this.onlinetotalSizeSY =
            res.data.content.onlineProfitIncomeItems.totalSize;
        } else {
          this.onlinetableDataSY = [];
        }
      });
      ...
      plusMemberDetail({ params: parms }).then(res => {
        if (res.data.messageCode == "MSG_1001") {
          this.onlinetableDataFSY =
            res.data.content.onlineLossIncomeItems.items;
          this.onlinetotalSizeFSY =
            res.data.content.onlineLossIncomeItems.totalSize;
        } else {
          this.onlinetableDataFSY = [];
        }
      });
    ...
    getOfflineSY(val) {
      ...
      plusMemberDetail({ params: parms }).then(res => {
        if (res.data.messageCode == "MSG_1001") {
          ...
          this.offlinetotalSizeSY =
            res.data.content.offlineIncomeItems.totalSize;
        } else {
    ...
    getOnlineXF(val) {
      ...
      plusMemberDetail({ params: parms }).then(res => {
        if (res.data.messageCode == "MSG_1001") {
          ...
          this.onlinetotalSizeXF =
            res.data.content.onlineConsumeItems.totalSize;
        } else {
